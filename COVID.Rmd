...
ggplot() +
  ...
  scale_x_date(limits = c(as.Date("2020-02-18"), as.Date("2020-03-15"))) +
  coord_cartesian(ylim=c(0, 1000)) #for a true zoom without throwing away data that is out of bounds as when using limits in y_scale_continous
```
