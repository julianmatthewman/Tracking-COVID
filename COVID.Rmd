...
ts_conf <- read.csv("time_series_19-covid-Confirmed.csv")
ts_deaths <- read.csv("time_series_19-covid-Deaths.csv")
ts_recovered <- read.csv("time_series_19-covid-Recovered.csv")
ts_conf_global <- read.csv("time_series_covid19_confirmed_global.csv")
ts_conf_global <- read.csv("time_series_covid19_deaths_global.csv")
```
